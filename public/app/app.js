...
System.register(['@angular/core', '@angular/platform-browser', '@angular/http', "@angular/forms", './app.admincomponent'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
        var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    ...
    var core_1, platform_browser_1, http_1, forms_1, app_admincomponent_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (app_admincomponent_1_1) {
                app_admincomponent_1 = app_admincomponent_1_1;
            }],
        execute: function() {
            AppModule = (function () {
                function AppModule() {
...
System.register(['@angular/platform-browser-dynamic', './app.adminmodule'], function(exports_1, context_1) {
    "use strict";
    var __moduleName = context_1 && context_1.id;
    var platform_browser_dynamic_1, app_adminmodule_1;
    var platform;
    return {
        setters:[
            function (platform_browser_dynamic_1_1) {
            ...
            function (app_adminmodule_1_1) {
                app_adminmodule_1 = app_adminmodule_1_1;
            }],
        execute: function() {
            platform = platform_browser_dynamic_1.platformBrowserDynamic();
            platform.bootstrapModule(app_adminmodule_1.AppModule);
        }
    }
});
